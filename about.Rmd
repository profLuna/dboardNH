...
Details on the analyses for New Hampshire for specific burden categories are available in technical reports at the following links:

* [Transportation](reports/Transport_New HampshirePDF.pdf)
* [Emissions](reports/Emissions_New HampshirePDF.pdf)
* [Heat](reports/LST_New HampshirePDF.pdf)
* [Evacuation](reports/Evacuation_New HampshirePDF.pdf)

Research code for these analyses is available at https://github.com/profLuna/Investing-for-Equity

This online application is built with [R version 4.0.3 (R Core Team, 2020)](https://www.r-project.org/) using the [R Markdown](https://rmarkdown.rstudio.com/) package in Rstudio. Charts, tables, and maps use [Highcharts](http://www.highcharts.com/),  [DataTables](https://datatables.net/), and [Leaflet.js](http://leafletjs.com/), respectively, all accessed through their corresponding R packages.  The R code for this online dashboard is available at https://github.com/profLuna/dboardNH
